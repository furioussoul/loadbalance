...
public class RandomEchoClient {
    private static final Logger logger = LoggerFactory.getLogger(RandomEchoClient.class);
    private final LoadBalancer loadBalancer;
    private final EventLoopGroup group;
    private final Bootstrap bootstrap;
    private final AtomicInteger requestCount = new AtomicInteger(0);

    public RandomEchoClient(List<Server> servers) {
    ...
    private void sendRequest() {
        Optional<Server> serverOpt = loadBalancer.getRandomServer();
    ...
    public static void main(String[] args) {
        ...
        RandomEchoClient client = new RandomEchoClient(servers);
        client.start(10000);
    }
}
